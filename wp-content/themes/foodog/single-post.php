	...
	<div class="container">
		...
		<div class="main">
			<div class="post content">
				<h1 class="foodog-page-title"><a href="<?php the_permalink(); ?>"><?php the_title();?></a></h1><!-- titre de l'article -->
				...
				<div class="foodog-social-middle-bar"><!-- barre reseaux sociaux debut de l'article -->
					...
					<div class="foodog-post-social-begin"><!-- reseaux sociaux debut de l'article -->
						<span>Share</span><?php wp_nav_menu(['theme_location'=>'begin-post','container'=>false,'menu_class'=>'foodog-menu-begin-post']) ?>
					</div>
				</div>
				...
				<div class="foodog-post-social-end"><!-- reseaux sociaux fin de l'article -->
					<p>Share</p><?php wp_nav_menu(['theme_location'=>'footer-post','container'=>false,'menu_class'=>'foodog-menu-footer-post']) ?>
				</div>
